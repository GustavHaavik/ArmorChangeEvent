...
public class ArmorChangeEvent extends PlayerEvent implements Cancellable {
     ...
     */
    public ArmorChangeEvent(final Player player, final EquipMethod equipType, final ArmorType type, final ItemStack oldArmorPiece, final ItemStack newArmorPiece) {
        super(player);
